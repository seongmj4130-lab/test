...
def create_baseline2_ui_data_fixed():
    ...
    existing_data['kospi_tr_monthly_return'] = existing_data['kospi200_monthly_return'] + monthly_dividend_yield
    existing_data['kospi_tr_cumulative_return'] = (1 + existing_data['kospi_tr_monthly_return']).cumprod() - 1
    existing_data['kospi_tr_log_cumulative_return'] = np.log(1 + existing_data['kospi_tr_cumulative_return'])
    ...
    print(f"✅ 데이터 정리 완료: {len(baseline2_data)}행 × {len(baseline2_data.columns)}열")
