...
for i, horizon in enumerate(horizons):
    ...
    ax.plot(
        horizon_data["month"],
        horizon_data["kospi_cum_return_pct"],
        label="KOSPI",
        color=colors[0],
        linewidth=2,
        marker="o",
    ...
    # 그래프 설정
    ax.set_title(
        f"{horizon}일 보유 기간 - 누적 수익률 추이", fontsize=14, fontweight="bold"
    )
...
print(
    "✅ 6개 누적 수익률 그래프가 'strategies_cumulative_returns_6charts.png'로 저장되었습니다."
)
print("\n📊 그래프 분석:")
