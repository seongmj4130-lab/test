...
def test_single_backtest(strategy_name: str, holding_days: int):
    ...
    try:
        ...
        if (
            redesigned
            and "params" in redesigned
            and strategy_name in redesigned["params"]
        ):
        ...
        print(
            f"⚙️ BacktestConfig: top_k={backtest_cfg.top_k}, cost_bps={backtest_cfg.cost_bps}, slippage_bps={backtest_cfg.slippage_bps}"
        )
