...
# 날짜 범위 비교
if results.get("l5_short", {}).get("exists") and results.get("l8_short", {}).get(
    "exists"
):
    ...
    print(
        f'  일치 여부: {"✅ 일치" if l5_date_min == l8_date_min and l5_date_max == l8_date_max else "⚠️ 불일치"}'
    )

if results.get("l5_long", {}).get("exists") and results.get("l8_long", {}).get(
    "exists"
):
