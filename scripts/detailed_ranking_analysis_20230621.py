...
print(
    f"📊 데이터 건수: 단기 {len(short_20230621)}개, 장기 {len(long_20230621)}개, 통합 {len(integrated_20230621)}개\n"
)
...
if "통합" in all_top5:
    ...
    print(
        f"   통합: {integrated_1st['종목명(ticker)']} (점수: {integrated_1st['score']:.6f})"
    )
...
if all_top5:
    ...
    result_df.to_csv(
        "detailed_rankings_20230621.csv", index=False, encoding="utf-8-sig"
    )
