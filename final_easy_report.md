...
return_col = cfg.get('return_col', 'true_short')  # BT20: 'true_short', BT120: 'true_long'
...
**작성 완료일**: 2026-01-05 (최종 업데이트)  
**버전**: Phase 9 + 뉴스 피처 추가 (2026-01-04) + 투트랙 구조 리팩토링 (2026-01-05)  
**최종 검토**: 
- 코드와 데이터 기준 100% 반영
- 뉴스 피처 추가 반영
