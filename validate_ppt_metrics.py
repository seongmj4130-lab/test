...
def validate_ppt_metrics():
    ...
    try:
        ...
        strategies_cum = ['BT20 단기 (20일)', 'BT20 앙상블 (20일)', 'BT120 장기 (120일)', 'BT120 앙상블 (120일)', 'KOSPI200']
    ...
    print('최종 누적 수익률 (요약): BT20 단기 26.2%, BT20 앙상블 22.4%, BT120 장기 17.9%, BT120 앙상블 13.5%, KOSPI200 6.4%')
    print('월별 승률: BT20 단기 77.3%, BT20 앙상블 68.2%, BT120 장기 54.5%, BT120 앙상블 59.1%, KOSPI200 50.0%')
