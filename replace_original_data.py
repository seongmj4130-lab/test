...
def replace_original_data():
    ...
    for horizon in horizons:
        ...
        for idx, row in monthly_horizon.iterrows():
            ...
            cum_returns['kospi200_pr'] = (1 + cum_returns['kospi200_pr']/100) * (1 + mret_kospi/100) - 1
            cum_returns['short'] = (1 + cum_returns['short']/100) * (1 + mret_short/100) - 1
            cum_returns['long'] = (1 + cum_returns['long']/100) * (1 + mret_long/100) - 1
            cum_returns['mix'] = (1 + cum_returns['mix']/100) * (1 + mret_mix/100) - 1
    ...
    # 월별 수익률이 일치하는지 확인
    mret_cols = ['kospi200_pr_mret_pct', 'short_mret_pct', 'long_mret_pct', 'mix_mret_pct']
